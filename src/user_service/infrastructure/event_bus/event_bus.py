...
from user_service.infrastructure.log.processors import additionally_serialize
from user_service.infrastructure.message_broker import Message, MessageBroker
