...
from user_service.application.user.interfaces.persistence import GetUsersFilters, UserReader, UserRepo
...
from user_service.infrastructure.db.converters import (
...
from user_service.infrastructure.db.models.user import User
