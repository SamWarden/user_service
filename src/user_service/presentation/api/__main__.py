...
from user_service.infrastructure.di import DiScope, init_di_builder, setup_di_builder
...
from user_service.infrastructure.mediator import init_mediator, setup_mediator
