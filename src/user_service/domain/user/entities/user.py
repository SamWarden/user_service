...
from user_service.domain.common.entities.aggregate_root import AggregateRoot
from user_service.domain.user.events import FullNameUpdated
from user_service.domain.user.events.user_created import UserCreated
from user_service.domain.user.events.user_deleted import UserDeleted
from user_service.domain.user.events.username_updated import UsernameUpdated
